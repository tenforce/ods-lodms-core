...
public class AboutDialog extends Window {
    ...
    public AboutDialog() {
        ...
        Label aboutText = new Label("<div class=\"lodms_about\">" +
                "<p>The Open Data Interoperability Platform is an extension of the LODMS developed by <a href=\"http://tenforce.com\">Tenforce</a> in the course of  the <a href=\"http://opendatasupport.eu\">Open Data Support</a> project.</p>" +
